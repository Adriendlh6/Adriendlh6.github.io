...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .print-logo{display:block;width:22mm;height:22mm;object-fit:contain;object-position:center center;flex:0 0 22mm}
...
<body>${markup}</body>
  ...
  function supplierDetailPrintDocument(item){
    ...
    const markup = ''
      ...
      + '<img src="' + esc(logoUrl) + '" alt="Copilot boulangerie" class="print-logo">'
